...
const ICONS = {
  ...
  sparkles:
    'p:M12 4.5c.7 3.4 2.1 4.8 5.5 5.5-3.4.7-4.8 2.1-5.5 5.5-.7-3.4-2.1-4.8-5.5-5.5 3.4-.7 4.8-2.1 5.5-5.5z|p:M19 2.5c.3 1.5.9 2.1 2.4 2.4-1.5.3-2.1.9-2.4 2.4-.3-1.5-.9-2.1-2.4-2.4 1.5-.3 2.1-.9 2.4-2.4z|p:M6 15.5c.35 1.75 1.05 2.45 2.8 2.8-1.75.35-2.45 1.05-2.8 2.8-.35-1.75-1.05-2.45-2.8-2.8 1.75-.35 2.45-1.05 2.8-2.8z',
  image:
    'r:3,4.5,18,15,2.4|c:8.6,9.6,1.7|p:M21 15.5 16.2 10.7a1.6 1.6 0 0 0-2.3 0L5.5 19.1',
